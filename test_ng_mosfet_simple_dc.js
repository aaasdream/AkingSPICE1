...
function testNgMosfetSimpleDC() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const vgate = voltage_source_1.VoltageSourceFactory.createDC('Vgate', ['gate', '0'], 10); // 固定 10V
        ...
        try {
            ...
            if (result.success && result.waveformData) {
                ...
                if (drainIdx !== undefined) {
                    const vDrain = ((_a = nodeVoltages.get(drainIdx)) === null || _a === void 0 ? void 0 : _a[0]) || 0;
